...
sub get_state {
    ...
    my @headers = ('POS', 'CPos', '#', 'Class', 'F. Name', 'L. Name', 'Yr.', 'Model', 'Disp.', 'Best Time', 'Last Lap', 'Gap', 'Laps' );

    # what is used for the hash labels. This should be passed to this object
    @hashkeys = qw(position class_pos car class first_name last_name year model displacement best_lap last_lap gap laps);
